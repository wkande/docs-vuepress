...
<template>
  <teleport to="body">
    <div class="api3-search-modal" style="  user-select: none;" v-if="isModalActive">
      <button @click="isModalActive = !isModalActive" style="float:right;">
        <div style="font-size:28pt;font-weight:600;transform: scaleY(0.7);">X</div>
      </button>
      <br/>
      <SearchBox />
    </div>
  ...
  <span>
    <button
      class="api3-search-btn" style="user-select: none;"
