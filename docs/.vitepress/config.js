export default {
    ...
    head: [
      ['link', { rel: "apple-touch-icon", sizes: "180x180", href: "/small-logo.png"}],
      ['link', { rel: "icon", type: "image/png", sizes: "32x32", href: "/small-logo.png"}],
    ...
    themeConfig: {
        ...
        socialLinks: [
          ...
          { icon: 'discord', link: 'https://discord.com/channels/758003776174030948/765618225144266793' }
        ],
        footer: {
