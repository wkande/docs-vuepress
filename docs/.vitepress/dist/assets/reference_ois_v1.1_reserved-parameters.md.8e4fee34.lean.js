...
const g = JSON.parse(
  ...
  y = i("", 55);
function m(s, b, A, D, C, v) {
  const a = c("reference-VersionPicklist");
  return (
    o(),
    t("div", null, [
      l(a),
      e("h1", u, [r(p(s.$frontmatter.title) + " ", 1), h]),
      y,
    ])
  );
}
const F = n(d, [["render", m]]);
