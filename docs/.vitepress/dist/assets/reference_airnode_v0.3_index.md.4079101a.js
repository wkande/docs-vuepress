...
const b = JSON.parse(
    '{"title":"ChangeLog","description":"","frontmatter":{"lang":"en-US","title":"ChangeLog","sidebarHeader":"Reference","sidebarSubHeader":"\u2192 Airnode"},"headers":[{"level":2,"title":"v0.3","slug":"v0-3","link":"#v0-3","children":[]}],"relativePath":"reference/airnode/v0.3/index.md"}'
  ),
  s = { name: "reference/airnode/v0.3/index.md" },
  ...
  h = e(
    ...
    [
      ...
      e(
        "a",
        { class: "header-anchor", href: "#v0-3", "aria-hidden": "true" },
        "#"
      ),
    ],
    -1
