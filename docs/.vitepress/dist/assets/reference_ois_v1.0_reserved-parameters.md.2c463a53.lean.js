...
const C = JSON.parse(
  ...
  d = r("", 55);
function u(s, h, y, m, b, A) {
  return (
    n(),
    o("div", null, [e("h1", i, [t(l(s.$frontmatter.title) + " ", 1), c]), d])
  );
}
const v = a(p, [["render", u]]);
