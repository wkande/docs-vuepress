...
const g = JSON.parse(
    '{"title":"readDataFeedWithDapiName()","description":"","frontmatter":{"title":"readDataFeedWithDapiName()","folder":"dApp Developers"},"headers":[{"level":2,"title":"Example Code","slug":"example-code","link":"#example-code","children":[]},{"level":2,"title":"Parameters","slug":"parameters","link":"#parameters","children":[]},{"level":2,"title":"Returns","slug":"returns","link":"#returns","children":[]}],"relativePath":"reference/dapis/developers/read-data-feed-with-dapi-name.md"}'
  ),
  h = { name: "reference/dapis/developers/read-data-feed-with-dapi-name.md" },
...
function A(e, C, f, F, b, v) {
  ...
  return (
    ...
    i("div", null, [
      ...
      o("h1", D, [s(n(e.$frontmatter.title) + " ", 1), y]),
      a(p),
      u,
    ])
  );
}
const T = r(h, [["render", A]]);
export { g as __pageData, T as default };
