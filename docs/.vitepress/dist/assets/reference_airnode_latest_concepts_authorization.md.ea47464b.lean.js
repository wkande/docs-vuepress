...
function m(n, D, f, w, g, x) {
  ...
  return (
    l(),
    p("div", null, [
      a("h1", y, [c(d(n.$frontmatter.title) + " ", 1), b]),
      e(t),
      e(r),
      e(i, { class: "table-of-contents", "include-level": [2, 5] }),
      C,
    ])
  );
}
const v = o(A, [["render", m]]);
