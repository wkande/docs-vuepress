...
const b = JSON.parse(
    '{"title":"ChangeLog","description":"","frontmatter":{"lang":"en-US","title":"ChangeLog","sidebarHeader":"Reference","sidebarSubHeader":"\u2192 Airnode"},"headers":[{"level":2,"title":"v0.2","slug":"v0-2","link":"#v0-2","children":[]}],"relativePath":"reference/airnode/v0.2/index.md"}'
  ),
  s = { name: "reference/airnode/v0.2/index.md" },
  ...
  h = e(
    ...
    [
      ...
      e(
        "a",
        { class: "header-anchor", href: "#v0-2", "aria-hidden": "true" },
        "#"
      ),
    ],
    -1
